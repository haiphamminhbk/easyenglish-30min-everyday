...
export default function FormattedNote({ content, className = '' }) {
  if (!content || !content.trim()) {
    return <span className="text-gray-400 italic">Không có ghi chú nào.</span>;
  }

  return (
    <div
      className={`prose prose-sm sm:prose-base max-w-none text-gray-800 leading-relaxed break-words ${className}`}
