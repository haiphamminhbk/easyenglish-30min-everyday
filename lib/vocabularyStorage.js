...
// ==========================================================================
// High-Definition Studio Audio Pronunciation Engine
// ==========================================================================
...
export function speakWord(text, rate = 0.9, accent = 'us') {
  ...
  // Accent type code (type=2 is US American, type=1 is UK British)
  const typeCode = accent === 'uk' ? 1 : 2;

  // Primary URL: Studio-quality audio stream
  const primaryUrl = `https://dict.youdao.com/dictvoice?audio=${encodeURIComponent(cleanText)}&type=${typeCode}`;
  // Fallback URL: Google TTS
  ...
  audio.playbackRate = rate <= 0.8 ? 0.75 : 1.0;
