/**
 * Lo-fi Ambient Music Manager
 * Provides relaxing background study/focus music with Web Audio fallback
 */
...
export const LOFI_PLAYLIST = [
  {
    ...
    subtitle: 'Nhạc thư giãn tập trung học tập',
    src: 'https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3?filename=lofi-study-112191.mp3',
  },
  {
    id: 'lofi-coffee',
    title: '☕ Morning Focus Flow',
    subtitle: 'Giai điệu thư thái tăng hiệu suất',
...
export async function playLofiMusic(volume = 0.3, trackIdx = null) {
  ...
  try {
    ...
    // If audio element blocked or network fails, fallback to Web Audio synth
    startLofiSynth();
    isPlaying = true;
    notifyListeners();
    return true;
